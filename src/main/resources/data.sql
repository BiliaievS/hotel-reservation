...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Bell'), '2019-01-01');
